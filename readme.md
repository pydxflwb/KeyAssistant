...
_一键网课助手_ 是一个帮助SJTU学生快速登录Zoom平台含密码会议室的程序
  ...
  * 2020.04.19：近期可能的更新预告
	...
	<video src="https://github.com/pydxflwb/KeyAssistant/tree/master/github_video/fufu.mp4" controls="controls" width="500" height="300">QAQ 您的浏览器不支持看fufu，请到文件里下载视频吧</video>
 ...
 * 2020.04.19：近期可能的更新预告
	1.一键按钮增加了一只可爱的初音fufu！开发完成后续一并上线 [fufu视频文件](https://github.com/pydxflwb/KeyAssistant/tree/master/github_video/fufu.mp4)
